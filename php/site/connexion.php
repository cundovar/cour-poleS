...
{  //         nom du cookie  valeur   duree de vie
    setcookie(session_name(),'',time()-42000,'/');
    
    //setcookies permet de creer un cookie sauf si
    
}// detruit le fichier de session ( dossier tmp)
session_destroy();
}
        ...
        <div class="col-md-6 mx-auto">
            <form action="" method="post">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="pseudo" id="pseudo" placeholder="💬 Indiquer votre Pseudo">
                </div>
                <div class="mb-3">
                    <label for="mdp" class="form-label">Mot de passe</label>
                    <input type="password" class="form-control" name="mdp" id="mdp" placeholder="🔑 Indiquer votre Mot de passe">
                </div>
